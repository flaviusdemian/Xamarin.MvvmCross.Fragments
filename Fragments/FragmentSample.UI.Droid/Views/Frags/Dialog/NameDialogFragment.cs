...
namespace FragmentSample.UI.Droid.Views
{
    public class NameDialogFragment : MvxDialogFragment
    {
        ...
        public override Dialog OnCreateDialog(Bundle savedState)
        {
            ...
            View view = this.BindingInflate(Resource.Layout.Dialog_Names, null);
            ...
            dialog.SetPositiveButton("OK", (s, a) =>
                Toast.MakeText(Activity.ApplicationContext, string.Format("Full name is: {0}", NamesViewModel.FullName),
